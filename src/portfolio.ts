...
const portfolioInfo: TPortfolioInfo = {
  ...
  "experience": {
    ...
    "description": "I've contributed to innovative startups and established companies as a Software Engineer.",
  ...
  "contact": {
    "contactSection": {
      ...
      "description": "Feel free to reach out to me through any of the platforms below."
    },
    "addressSection": {
      "title": "Address",
